...
## ref: https://discorpy.readthedocs.io/en/latest/usage/demo_06.html

# Initial parameters
# file_path = "/Users/jibly/Documents/labHandling/lab_handling_system/chess/Photo on 7-29-24 at 4.25 PM.jpg"
file_path = "/Users/jibly/Documents/labHandling/lab_handling_system/chess/Photo on 8-1-24 at 3.58 PM.jpg"
output_base = "/Users/jibly/Documents/labHandling/lab_handling_system/output/fisheye"
...
list_hor_lines = prep.group_dots_hor_lines(list_points_hor_lines, slope_hor, dist_hor,
                                           ratio=0.2, num_dot_miss=2, accepted_ratio=0.6)
...
img = io.load_image("/Users/jibly/Documents/labHandling/lab_handling_system/output/original.jpg", average=False)
img_corrected = np.copy(img)
for i in range(img.shape[-1]):
    img_corrected[:, :, i] = post.unwarp_image_backward(img[:, :, i], xcenter,
                                                        ycenter, list_fact)
